  ...
  const floaterScript = `
    class FloaterButton {
        constructor(options = {}) {
            ...
            this.buttonClass = 'btn-${generateId()}-floating-button';
            this.popupClass = 'btn-${generateId()}-popup';
            this.closeButtonClass = 'btn-${generateId()}-close-button';
            this.tooltipClass = 'btn-${generateId()}-tooltip';
            this.createStyles();
            this.createButton();
            this.createPopup();
            this.createTooltip();
